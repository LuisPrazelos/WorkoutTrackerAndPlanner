    ...
    <flux:modal name="confirm-user-deletion" :show="$errors->isNotEmpty()" focusable class="max-w-lg">
        <form method="POST" wire:submit="deleteUser" class="space-y-6">
            <div>
                ...
                <flux:subheading>
                    {{ __('Zodra je account is verwijderd, worden alle gegevens permanent gewist. Voer je wachtwoord in om te bevestigen dat je je account permanent wilt verwijderen.') }}
                </flux:subheading>
            </div>
