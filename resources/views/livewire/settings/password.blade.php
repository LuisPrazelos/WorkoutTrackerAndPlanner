<section class="w-full">
    ...
    <x-settings.layout :heading="__('Wachtwoord bijwerken')" :subheading="__('Zorg ervoor dat je account een lang, willekeurig wachtwoord gebruikt om veilig te blijven')">
